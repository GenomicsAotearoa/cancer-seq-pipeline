...
if(is.vector(S.filtered.table)){
	...
	S.filtered.table %>% 
		...
		#mutate(IGV=paste0("<a href='http://localhost:60151/goto?locus=",IGV,"'>",IGV,"</a>")) %>%
...
```{r, echo=FALSE, message=FALSE, warning=TRUE, out.width = "900px", out.height= "350px"}
